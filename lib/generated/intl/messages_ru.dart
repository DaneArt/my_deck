...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "deck_call_to_sign_up" : MessageLookupByLibrary.simpleMessage("Присоединитесь, чтобы наполнить свою библиотеку колодами."),
    ...
    "error_value_invalid_password" : MessageLookupByLibrary.simpleMessage("Пароль должен содержать как минимум 1 цифру, 1 прописную букву и 1 строчную букву."),
    ...
    "library_sign_in_to_create" : MessageLookupByLibrary.simpleMessage("Войдите, чтобы создать колоду."),
    ...
    "login_sign_up" : MessageLookupByLibrary.simpleMessage("Приосединиться"),
