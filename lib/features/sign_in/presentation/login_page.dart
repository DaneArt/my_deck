          ...
          Align(
            ...
            child: Transform.translate(
              ...
              child: Container(
                height: 128,
                width: 128,
                child: Image.asset('lib/assets/mydeck_logo.png'),
              ),
            ),
          ),
          Align(
...
class _InitialLoginFormState extends State<InitialLoginForm>
    with WidgetsBindingObserver {
  final formInputFieldKey = GlobalKey<FormFieldState>();
  final formInputTextController = TextEditingController();
  final loginFormKey = GlobalKey<FormState>();
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          LoginField(
            fieldKey: formInputFieldKey,
            controller: formInputTextController,
            onChanged: (input) => BlocProvider.of<SignInBloc>(context)
                .add(SignInEvent.emailOrLoginChanged(input)),
              ...
              children: <Widget>[
                LoginButton(
                    ...
                    onPressed: () {
                      ...
                      if (formInputFieldKey.currentState.validate()) {
                        BlocProvider.of<SignInBloc>(context)
